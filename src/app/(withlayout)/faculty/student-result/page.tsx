...
const StudentResultPage = () => {
  ...
  const handleUpdateFinalMarks = async (values: any) => {
    ...
    try {
      ...
      if (res?.data) {
        message.success("Final Marks Published");
      }
    ...
    },
    {
      ...
      render: function (data: any) {
        ...
        return (
          <>
            <Link
              href={`/faculty/update-mark?&examType=${data?.examType}&marks=${data?.marks}&academicSemesterId=${data?.academicSemesterId}&studentId=${data?.studentId}&courseId=${courseId}&offeredCourseSectionId=${offeredCourseSectionId}`}
            >
